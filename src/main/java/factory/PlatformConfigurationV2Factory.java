...
public class PlatformConfigurationV2Factory {
    ...
    public final PlatformConfigurationV2Factory addComponentsFromJsonNode(final JsonNode refNode) {
        if (refNode.isArray()) {
            for (final JsonNode part : refNode) {
                ComponentIdentifierV2FactoryRA2 component = ComponentIdentifierV2FactoryRA2.fromJsonNode(part);
	...
	public String toString() {
		return "PlatformConfigurationV2Factory "
				+ "\n [platformConfigComponents=" + platformConfigComponents
				+ "\n platformConfigProperties=" + platformConfigProperties 
				+ "\n componentIdentifiersUri=" + componentIdentifiersUri 
				+ "\n platformPropertiesUri=" + platformPropertiesUri + "]";
	}
